...
st.markdown("""
    <style>
        /* Desce o título e define fundo claro */
        .block-container { 
        ...
        /* --- SOLUÇÃO PARA COLUNAS FIXAS (STICKY) --- */
        div[data-testid="stTable"] { 
            overflow-x: auto !important; 
        }
        
        /* Fixar a 1ª Coluna (Classificação) */
...
with tab_times:
    ...
    b_logo, b_cam = get_base64_img(str(d["LOGO"])), get_base64_img(str(d["CAMISA"]))
    
    st.markdown(f"""
    <div class="flex-fotos">
        <div class="foto-item"><img src="data:image/png;base64,{b_logo if b_logo else ''}" width="100"><p>Escudo</p></div>
        <div class="foto-item"><img src="data:image/png;base64,{b_cam if b_cam else ''}" width="100"><p>Camisa</p></div>
    </div>
    """, unsafe_allow_html=True)
